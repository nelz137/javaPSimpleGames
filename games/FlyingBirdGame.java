...
public class FlyingBirdGame extends JPanel implements ActionListener, KeyListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (!gameOver) {
            ...
            for (Rectangle p : pipes)
                if (p.intersects(bird)) gameOver = true;
